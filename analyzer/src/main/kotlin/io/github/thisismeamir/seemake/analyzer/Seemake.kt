package io.github.thisismeamir.seemake.analyzer


import io.github.thisismeamir.seemake.analyzer.edge.*
import io.github.thisismeamir.seemake.analyzer.report.ReportGenerator
import io.github.thisismeamir.seemake.analyzer.report.ReportExporter
import java.io.File
...
object Seemake {
     ...
     */
    fun analyze(rootDirectory: String): io.github.thisismeamir.seemake.analyzer.model.CMakeProject {
     ...
     * Analyze a CMake project with default settings
     */
    fun analyze(rootDirectory: File): io.github.thisismeamir.seemake.analyzer.model.CMakeProject {
        val analyzer = _root_ide_package_.io.github.thisismeamir.seemake.analyzer.core.CMakeAnalyzer()
    ...
    fun analyze(
        rootDirectory: File,
        edgeCaseHandlers: List<io.github.thisismeamir.seemake.analyzer.edge.EdgeCaseHandler>
    ): io.github.thisismeamir.seemake.analyzer.model.CMakeProject {
        val analyzer = _root_ide_package_.io.github.thisismeamir.seemake.analyzer.core.CMakeAnalyzer(edgeCaseHandlers)
        return analyzer.analyze(rootDirectory)
    }
    ...
    fun analyzeAndReport(rootDirectory: File): String {
        ...
        val generator = _root_ide_package_.io.github.thisismeamir.seemake.analyzer.report.ReportGenerator()
    ...
    fun analyzeAndSaveReports(
        ...
        formats: Set<io.github.thisismeamir.seemake.analyzer.ReportFormat> = setOf(
            _root_ide_package_.io.github.thisismeamir.seemake.analyzer.ReportFormat.TEXT,
            _root_ide_package_.io.github.thisismeamir.seemake.analyzer.ReportFormat.JSON,
            _root_ide_package_.io.github.thisismeamir.seemake.analyzer.ReportFormat.SUMMARY,
            _root_ide_package_.io.github.thisismeamir.seemake.analyzer.ReportFormat.DEPENDENCY_GRAPH
        )
    ) {
        val project = analyze(rootDirectory)
...
fun main(args: Array<String>) {
    ...
    try {
        val project = Seemake.analyze(rootDir)
        ...
        Seemake.analyzeAndSaveReports(rootDir, outputDir)
